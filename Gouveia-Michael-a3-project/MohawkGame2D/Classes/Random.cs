...
public static class Random
{
    ...
    /// <returns>
    ///     Returns a random value from 0 (inclusive) to <paramref name="max"/> (exclusive).
    /// </returns>
    ...
    /// <param name="max">The maximum value (excluded from range).</param>
    /// <returns>
    ///     Returns a random value from <paramref name="min"/> (inclusive) to
    ...
    ///     values from 0 (inclusive) to 256 (exclusive). A is always 255 (opaque).
    /// </returns>
    ...
    /// <returns>
    ///     Returns a random color with R, G, B, and A component values of
    ///     different  values from <paramref name="min"/> (inclusive) to
    ///     <paramref name="max"/> (inclusive). A is always 255 (opaque)
    ///     when <paramref name="ignoreAlpha"/> is true.
    /// </returns>
    public static Color Color(Color min, Color max, bool ignoreAlpha)
    {
        byte r = (byte)rng.Next(min.R, max.R + 1);
        byte g = (byte)rng.Next(min.G, max.G + 1);
        byte b = (byte)rng.Next(min.B, max.B + 1);
        byte a = (byte)rng.Next(min.A, max.A + 1);
        a = ignoreAlpha ? byte.MaxValue : a;
    ...
    ///     value from 0 (inclusive) to 256 (exclusive). A is always 255 (opaque).
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    ///     Returns a random color with R, G, and B component values of
    ///     the same value from <paramref name="min"/> (inclusive) to
    ///     <paramref name="max"/> (inclusive). A is always 255 (opaque).
    /// </returns>
    public static Color GrayscaleColor(int min, int max)
        => new((byte)rng.Next(min, max + 1));
    ...
    /// <param name="max">The maximum value (excluded from range).</param>
    /// <returns>
    ///     Returns a random value from 0.0f (inclusive) to <paramref name="max"/> (exclusive).
    /// </returns>
    ...
    /// <param name="max">The maximum value (excluded from range).</param>
    /// <returns>
    ///     Returns a random value from <paramref name="min"/> (inclusive) to <paramref name="max"/> (exclusive).
    /// </returns>
    ...
    ///     (inclusive) to (<paramref name="max"/>, <paramref name="max"/>) (exclusive).
    /// </returns>
    public static Vector2 Vector2(Vector2 min, Vector2 max)
        => new(Float(min.X, max.X), Float(min.Y, max.Y));
    ...
    ///     (inclusive) to (<paramref name="maxX"/>, <paramref name="maxY"/>) (exclusive).
    /// </returns>
